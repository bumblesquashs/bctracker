...
<div class="page-container">
    ...
    <div class="container flex-3">
        <div class="section">
            <div class="header" onclick="toggleSection(this)">
                <h2>{{ context.realtime_vehicle_type_plural }}</h2>
                % include('components/toggle')
            </div>
            <div class="content">
                % if allocations:
                ...
                % else:
                    <div class="placeholder">
                        ...
                        % elif days:
                            <h3>No {{ context }} {{ context.realtime_vehicle_type_plural.lower() }} have been recorded for the selected date range</h3>
                            <p>Please choose a different date range or check again later!</p>
                        % else:
                            <h3>No {{ context }} {{ context.realtime_vehicle_type_plural.lower() }} have been recorded</h3>
