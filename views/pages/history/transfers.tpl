...
<div id="page-header">
    <h1>{{ context.realtime_vehicle_type }} History</h1>
            ...
            <div class="content">
                ...
                % else:
                    <div class="placeholder">
                        ...
                        % elif filter == 'from':
                            <h3>No {{ context.realtime_vehicle_type_plural.lower() }} have been transferred from {{ context }}</h3>
                            <p>Please choose a different filter or check again later!</p>
                        % elif filter == 'to':
                            <h3>No {{ context.realtime_vehicle_type_plural.lower() }} have been transferred to {{ context }}</h3>
                            <p>Please choose a different filter or check again later!</p>
                        % else:
                            <h3>No {{ context.realtime_vehicle_type_plural.lower() }} have been transferred to or from {{ context }}</h3>
