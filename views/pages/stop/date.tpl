            ...
            <div class="content">
                <div class="info-box">
                    <div class="row section align-center">
                        ...
                        % next_date = date.next()
                        <a class="icon button" href="{{ get_url(stop.system, 'stops', stop, 'schedule', previous_date) }}">
                        ...
                        <a class="icon button" href="{{ get_url(stop.system, 'stops', stop, 'schedule', next_date) }}">
