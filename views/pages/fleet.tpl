        ...
        <div class="content">
            % if af_2024:
                <p>
                    ...
                    It includes every bus that is currently operated by BC Transit.
                </p>
                <p>Any vehicle that is marked as <span class="lighter-text">Unavailable</span> has not been tracked.</p>
