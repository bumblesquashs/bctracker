...
<div id="page-header">
    ...
    <div class="tab-button-bar">
        <a href="{{ route.url() }}" class="tab-button">Overview</a>
            ...
            <div class="content">
                <div class="info-box">
                    <div class="row section align-center">
                        ...
                        % next_date = date.next()
                        <a class="icon button" href="{{ route.url('schedule', previous_date) }}">
                            % include('components/svg', name='paging/left')
                        </a>
                        <div class="centred">
                            <h3>{{ date.format_long() }}</h3>
                            <a href="{{ route.url('schedule') }}">Return to week view</a>
                        </div>
                        <a class="icon button" href="{{ route.url('schedule', next_date) }}">
