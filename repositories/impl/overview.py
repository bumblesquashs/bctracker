...
class OverviewRepository:
    ...
    def find(self, context: Context, bus) -> Overview | None:
    ...
    def find_all(self, context: Context = Context(), last_record_context: Context = Context(), last_seen_context: Context = Context(), bus=None, limit=None) -> list[Overview]:
        ...
        return self.database.select('overview',
            ...
            filters={
                ...
                'overview.bus_number': bus_number,
                'last_record.system_id': last_record_context.system_id,
    ...
    def update(self, context: Context, overview, date, record):
        ...
        self.database.update('overview', values, {
            'agency_id': overview.context.agency_id,
