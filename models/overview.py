...
class Overview:
    ...
    def __init__(self, bus: Bus, first_seen_date: Date, first_seen_context: Context, first_record: Record | None, last_seen_date: Date, last_seen_context: Context, last_record: Record | None):
        self.bus = bus
